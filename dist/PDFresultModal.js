...
var PDFresultModal = function PDFresultModal(_ref2) {
  ...
  var _React$useState23 = _react.default.useState(1),
      ...
      penWeight = _React$useState24[0],
      set_penWeight = _React$useState24[1];

  var _React$useState25 = _react.default.useState(32),
      _React$useState26 = _slicedToArray(_React$useState25, 2),
      fixationSize = _React$useState26[0],
      set_fixationSize = _React$useState26[1];

  var _React$useState27 = _react.default.useState(0),
      _React$useState28 = _slicedToArray(_React$useState27, 2),
      pastTimeRange = _React$useState28[0],
      set_pastTimeRange = _React$useState28[1];

  var _React$useState29 = _react.default.useState(null),
      _React$useState30 = _slicedToArray(_React$useState29, 2),
      nowPDFviewInform = _React$useState30[0],
      set_nowPDFviewInform = _React$useState30[1];

  var _React$useState31 = _react.default.useState(3),
      _React$useState32 = _slicedToArray(_React$useState31, 1),
      minFixationCount = _React$useState32[0]; //콘트롤러


  var _React$useState33 = _react.default.useState(false),
      _React$useState34 = _slicedToArray(_React$useState33, 2),
      isFocus = _React$useState34[0],
      set_isFocus = _React$useState34[1];

  var _React$useState35 = _react.default.useState(200),
      _React$useState36 = _slicedToArray(_React$useState35, 1),
      mw = _React$useState36[0];

  var _React$useState37 = _react.default.useState(503),
      _React$useState38 = _slicedToArray(_React$useState37, 1),
      mh = _React$useState38[0]; //전체화면


  var _React$useState39 = _react.default.useState(false),
      _React$useState40 = _slicedToArray(_React$useState39, 2),
      isfullscreen = _React$useState40[0],
      set_isfullscreen = _React$useState40[1];
  ...
  var handleDraw = _react.default.useCallback(function () {
    ...
    var pT = pastTimeRange; // console.log("gazeData",gazeData)
    // //비율계산필요
    // //cw,ch는 지금의 사이즈고
    // //기록된 
  ...
  var _React$useState41 = _react.default.useState(null),
      ...
      jejuFontArrayBuffer = _React$useState42[0],
      set_jejuFontArrayBuffer = _React$useState42[1];
